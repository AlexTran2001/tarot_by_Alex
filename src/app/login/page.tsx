        ...
        <main className="min-h-screen flex items-center justify-center pt-24 pb-12 bg-white px-4">
            <div className="container-max mx-auto max-w-md w-full">
                <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8">
                    ...
                    {error && (
                        <div className="mb-6 p-4 bg-rose-50 border border-rose-200 text-rose-700 rounded-md text-sm font-body">
                            {error}
                        </div>
                    )}
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full px-4 py-3 bg-black text-white rounded-md font-medium font-body hover:bg-gray-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2"
                        >
                    ...
                    <div className="mt-6">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="mt-4 w-full px-4 py-3 border border-gray-300 rounded-md font-medium font-body hover:bg-gray-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 flex items-center justify-center gap-2"
                        >
                    ...
                    <div className="mt-6 text-center">
                        <Link
                            href="/"
                            className="text-sm text-gray-600 hover:text-black font-body underline-offset-4 hover:underline transition-colors"
                        >
                            ← Quay lại trang chủ
                        </Link>
                    </div>
