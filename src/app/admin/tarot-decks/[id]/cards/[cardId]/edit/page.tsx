...
export default function EditTarotCardPage() {
    ...
    const cardId = params?.cardId as string; // cardId is the card ID
    ...
    return (
        <main className="min-h-screen px-4 pt-24 pb-12 bg-white">
            <div className="container-max mx-auto">
                ...
                />
                <div className="mb-8">
                    <h1 className="text-4xl font-heading font-bold text-black mb-2">Chỉnh sửa lá bài Tarot</h1>
                    <p className="text-gray-600 font-body">Chỉnh sửa thông tin lá bài Tarot trong bộ bài {deck?.name || ""}</p>
                </div>
                <FormTarotCard deckId={id} cardId={cardId} />
            </div>
        </main>
    );
}
