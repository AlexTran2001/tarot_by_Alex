...
import FormTarotDeck from "@/components/admin/FormTarotDeck";
import Breadcrumb from "@/components/Breadcrumb";
import { checkIsAdmin } from "@/lib/adminUtils";

export default function EditTarotDeckPage() {
    ...
    return (
        <main className="min-h-screen px-4 pt-24 pb-12 bg-white">
            <div className="container-max mx-auto">
                ...
                />
                <div className="mb-8">
                    <h1 className="text-4xl font-heading font-bold text-black mb-2">Chỉnh sửa bộ bài Tarot</h1>
                    <p className="text-gray-600 font-body">Chỉnh sửa thông tin bộ bài Tarot</p>
                </div>
                <FormTarotDeck deckId={deckId} />
            </div>
        </main>
    );
}
