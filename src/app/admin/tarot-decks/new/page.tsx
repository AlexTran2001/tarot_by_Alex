...
export default function NewTarotDeckPage() {
    ...
    return (
        <main className="min-h-screen px-4 pt-24 pb-12 bg-white">
            <div className="container-max mx-auto">
                ...
                />
                <div className="mb-8">
                    <h1 className="text-4xl font-heading font-bold text-black mb-2">Tạo bộ bài Tarot mới</h1>
                    <p className="text-gray-600 font-body">Tạo bộ bài Tarot mới để quản lý các lá bài</p>
                </div>
                <FormTarotDeck />
            </div>
        </main>
