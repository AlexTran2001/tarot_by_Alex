...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed left-0 right-0 top-0 z-40 transition-colors duration-250 ease-smooth ${
        scrolled ? "bg-white/80 backdrop-blur-sm border-b border-black/5" : "bg-transparent"
      }`}
    >
      <div className="container-max mx-auto px-6 py-4 flex items-center justify-between">
        <a href="#" className="font-heading text-lg tracking-wide" aria-label="Trang chủ">Tarot by Alex</a>
        ...
        <div className="sm:hidden">
          <button
            ...
            aria-expanded={open}
            className="inline-flex items-center justify-center rounded-md p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
          >
